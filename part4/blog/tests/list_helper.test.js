...
describe('author with most posts', () => {
  test('when list has only one blog, equals the author with that one blog only', () => {
...
describe('author with most likes', () => {
  test('when list has only one blog, equals the author with number of likes that one post has', () => {
